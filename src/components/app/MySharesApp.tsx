...
export default function MySharesApp() {
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white">我的分享</h1>
          <p className="mt-0.5 text-sm text-slate-500">管理你分享出去的工作流和收藏夹合集</p>
        </div>
      </div>
      ...
      {MOCK_SHARES.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-800 py-20">
          ...
          <p className="mt-1 text-xs text-slate-600">在收藏夹或工作流页面可以生成分享链接</p>
        </div>
      )}
    </div>
  );
