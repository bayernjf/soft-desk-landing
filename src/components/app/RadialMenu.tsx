...
export function RadialMenu({
  ...
  // Middle-click to open radial menu
  useEffect(() => {
    const handleMouseDown = (e: MouseEvent) => {
      if (e.button === 1) {
        e.preventDefault();
        if (!isOpen) openMenu(e);
      }
    };
